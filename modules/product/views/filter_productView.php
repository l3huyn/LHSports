        ...
        if (!empty($list_product)) {
          if (isset($_GET['filter'])) {
            ...
            if ($filter == $filter_increase) {
              echo get_pagging($num_page, $page, "?mod=product&controller=index&action=filter_product&filter=lowtohigh");
            } else if ($filter == $filter_decrease) {
              echo get_pagging($num_page, $page, "?mod=product&controller=index&action=filter_product&filter=hightolow");
            }
          }
        }
        ?>
